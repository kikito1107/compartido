...
/** @var string $content Información adicional del correo */
?>
...
<head>
    ...
    <style type="text/css">
        ...
        .footer .tweet {
            background-image: url(https://i9.createsend1.com/static/eb/master/06-journal/imgf/tweet.png);
        }

        .footer .linkedinshare {
            background-image: url(https://i8.createsend1.com/static/eb/master/06-journal/imgf/lishare.png);
        }
        ...
        @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
            ...
            .footer .tweet {
                background-image: url(https://i5.createsend1.com/static/eb/master/06-journal/imgf/tweet@2x.png) !important;
            }

            .footer .linkedinshare {
                background-image: url(https://i2.createsend1.com/static/eb/master/06-journal/imgf/lishare@2x.png) !important;
            }
        ...
        @media only screen and (min-width: 0) {
            .one-col-feature blockquote {
                background-image: url(https://i3.createsend1.com/static/eb/master/06-journal/images/blockquote-bottomright.png);
                background-repeat: no-repeat;
        ...
        @media only screen and (max-width: 620px) {
            ...
            [class=wrapper] .one-col-feature blockquote {
                background-image: url(https://i8.createsend1.com/static/eb/master/06-journal/images/blockquote-bottomright@2x.png);
                background-size: 16px !important;
                padding: 0 !important;
            }

            [class=wrapper] .one-col-feature blockquote p:first-child {
                background-image: url(https://i7.createsend1.com/static/eb/master/06-journal/images/blockquote-topleft@2x.png);
                background-size: 16px !important;
            }
...
<center class="wrapper"
        style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f6f6f8;">
            ...
            <td style="padding: 10px 0 12px 0;vertical-align: middle;">
                <center>
                    <table class="full-width centered"
                           style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 600px;margin: 0 auto;">
                        <tbody>
                        <tr>
                            <td class="title column"
                                style="padding: 0;vertical-align: middle;text-align: left;font-family: Ubuntu,sans-serif;font-size: 10px;line-height: 16px;letter-spacing: 0.01em;text-decoration: none;width: 385px;color: gray;">
    ...
    <table class="header centered"
           style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 100%;color: gray;">
        <tbody>
        <tr>
            <td style="padding: 0;vertical-align: middle;">&nbsp;</td>
            <td class="logo emb-logo-padding-box"
                style="padding: 0;vertical-align: middle;mso-line-height-rule: at-least;width: 600px;padding-top: 12px;padding-bottom: 26px;">
                <div class="logo-center"
                     style="font-family: Avenir,sans-serif;color: #38434d;font-weight: bold;Margin-bottom: 0;text-align: center;font-size: 0px !important;line-height: 0 !important;"
                     align="center" id="emb-email-header"><img
                        style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 140px;"
                        src="<?= 'http://'. $_SERVER['SERVER_NAME'] . '/images/' ?>logo.png" alt="" width="140" height="160"></div>
            </td>
            <td style="padding: 0;vertical-align: middle;">&nbsp;</td>
        </tr>
        </tbody>
    ...
    <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
        ...
        <tr>
            <td style="padding: 0;vertical-align: middle;" align="center">
                <table class="one-col centered column-bg"
                       style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;background-color: #fff;width: 600px;table-layout: fixed;"
                       emb-background-style="">
                    <tbody>
                    <!-- Contenido del correo -->
                    <?php echo Yii::$app->view->render($template, [
                        'content' => $content
                    ]) ?>
    ...
    <table class="footer centered"
        ...
        <tr>
            <td style="padding: 0;vertical-align: middle;">&nbsp;</td>
            <td class="inner" style="padding: 58px 0 29px 0;vertical-align: middle;width: 600px;">
                <table class="right" style="border-collapse: collapse;border-spacing: 0;" align="right">
                    <tbody>
                    <tr>
                        <td style="padding: 0;vertical-align: middle;color: gray;font-size: 12px;line-height: 22px;max-width: 200px;mso-line-height-rule: at-least;">
                            <div class="sharing">
